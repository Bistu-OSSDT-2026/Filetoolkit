...
import { House, Picture, Document, VideoCamera, Headset, EditPen, Search, Fold, Expand } from "@element-plus/icons-vue";
...
const navItems = [
  ...
  { path: "/video", label: "视频处理", icon: VideoCamera },
  { path: "/audio", label: "音频提取", icon: Headset },
