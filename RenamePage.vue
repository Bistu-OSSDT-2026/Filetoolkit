...
.fail-section { margin-top: 12px; }
.fail-section h4 { margin: 0 0 8px; font-size: 14px; color: var(--el-color-warning); }
.fail-item { font-size: 13px; padding: 4px 0; color: var(--el-text-color-secondary); }
</style>
